...
description: >
  ...
  Use when the user invokes /openspec-bulk-archive or wants to clean up several done changes at once.
  Also trigger for archivar varios cambios openspec, bulk archive, limpiar changes completados.
license: MIT
...
8. **Execute archive for each confirmed change**
   ...
   a. **Sync specs** if delta specs exist:
      - Use the openspec-sync approach (agent-driven intelligent merge)
