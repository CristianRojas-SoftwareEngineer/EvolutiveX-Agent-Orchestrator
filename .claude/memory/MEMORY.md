# Knowledge Base — Scientific Maintenance

Index of lessons. One line per lesson. Phase 03 reads this as an explicit recall step;
Claude Code does NOT load this file automatically (see .claude/CLAUDE.md).

<!-- Format: - [lesson-slug](filename.md) — component/defect-class · profile -->
...
- [proxy-concurrent-step-attribution-2026-06](proxy-concurrent-step-attribution-2026-06.md) — gateway/audit-egress · cross-wiring concurrent hops · corrective
