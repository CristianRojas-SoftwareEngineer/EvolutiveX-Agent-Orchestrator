...
profile: corrective
created: 2026-06-08T18:34:00Z
status: done
verdict: resuelto — fix quirúrgico S1 aplicado; OpenSpec 2026-06-08-fix-proxy-audit-causal-gaps archivado
---

# Case Manifest — 20260608-proxy-audit-discrepancies

## Case

Inconsistencias críticas en la auditoría causal del Smart Code Proxy detectadas al comparar la sesión `7dd03f66-5838-474a-b640-409c3e8d49a0` (turno agentic simple con un Bash) contra el harness nativo de Claude Code: workflows wire huérfanos en `running`, `tool_result` no persistido, continuaciones con `messages: []`, y `body.json` incompleto (solo thinking) pese a SSE completo.

## Profile parameters

- **Objetivo:** restaurar el comportamiento correcto de la proyección causal-workflows-v1 eliminando defectos de observabilidad con cambio mínimo verificado.
...
- **Risk thresholds:** rechazar cambios amplios para defectos localizados; rechazar fix sin test covering; rechazar solución con blast radius innecesario.
...
openspec_change: "2026-06-08-fix-proxy-audit-causal-gaps"
case_run: 1
case_paused_at: ""
case_resumed_at: ""
