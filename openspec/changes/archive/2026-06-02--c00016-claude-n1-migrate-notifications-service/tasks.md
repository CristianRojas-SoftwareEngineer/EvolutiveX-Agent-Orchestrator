...
- [ ] 7.5 Archivar el L2 con `openspec-archive claude-n1-migrate-notifications-service` (mover a `openspec/changes/archive/2026-06-02--c00016-claude-n1-migrate-notifications-service/`).
  - _Criterio: el directorio del L2 desaparece de `openspec/changes/`_
  - _Criterio: el directorio aparece bajo `openspec/changes/archive/2026-06-02--c00016-claude-n1-migrate-notifications-service/`_
