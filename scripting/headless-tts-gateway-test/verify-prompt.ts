...
import { getProjectsDir } from '../session-manager/shared/paths.js';
import { projectPathToSlug } from '../session-manager/shared/project-slug.js';
...
export function findLatestTranscriptPath(
  projectRoot: string,
  minMtimeMs?: number,
): string | null {
