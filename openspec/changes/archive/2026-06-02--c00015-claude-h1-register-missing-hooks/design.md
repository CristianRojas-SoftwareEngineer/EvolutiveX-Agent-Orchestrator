...
**Decisión:** Las 8 entradas se registran en `.claude/settings.json` del proyecto, no en `C:\Users\Cristian\.claude\settings.json`. Las entradas del proyecto tienen precedencia sobre el user-level para las claves presentes (mecanismo de merge de Claude Code).
