...
El precedente inmediato es el orquestador archivado `2026-06-01--c00012-gateway-migration`, que introdujo 11 fases L2 sobre 3 bloques (C, G, P) con DAG de dependencias, phase registry, back-reference rule, y phase gate de 6 chequeos. Este orquestador reutiliza ese mismo patrón, reducido a 3 fases sobre 2 bloques (H, N).
