  ...
  ```json
  {
    "workflow_start": {
      ...
      "properties": {
        ...
        "invocation_method": {
          "type": "string",
          "enum": ["natural_language", "mention", "agent_flag", "ctrl_b"]
        },
        ...
        "parent_agent_id": {
          "type": ["string", "null"],
          "description": "From x-claude-code-parent-agent-id header; null for root agent"
        }
      },
      "required": [
        "event_type",
  ...
  ```json
  {
    "workflow_spawn": {
      ...
      "properties": {
        ...
        "parent_agent_id": {
          "type": "string",
          "description": "From x-claude-code-parent-agent-id header"
        }
      },
      "required": [
        "event_type",
        ...
        "phases": {
          ...
          "items": {
            ...
            "properties": {
              "phase_type": {
                "type": "string",
                "enum": ["initial", "continuation", "subagent_response", "deferred_continuation"]
              },
              "workflow_id": { "type": "string", "format": "uuid" },
              "agent_role": { "type": "string" },
              "blocks": {
                ...
                "items": {
                  ...
                  "properties": {
                    "block_type": {
                      "type": "string",
                      "enum": ["text", "thinking", "tool_use", "tool_result", "redacted_thinking"]
                    },
                    "index": { "type": "number" },
