...
**Trazabilidad:** este change supersede normativamente (para lectores actuales) la interpretación de **salida de sonido en win32** del archive `2026-06-03-add-notification-event-profiles`, sin modificar ese folder archivado. El catálogo sigue almacenando tokens BurntToast; el resolvedor traduce a `Notification.*` en runtime.
