...
- [ ] 10.3 Verificar que el change queda en `openspec/changes/archive/2026-06-04-proxy-hooks-promote-unified-installer/` y que la spec principal está sincronizada.
