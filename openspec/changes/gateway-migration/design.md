...
| P1 | `gateway-p1-new-session-layout` | Persistencia | P0, G4 | `npm run test` + casos 1–7, 15, 16, 19 del checklist [§37b](../../../docs/proposals/gateway-design.md#37b-checklist-de-aceptación-e2e-del-layout) | `docs/session-audit-model.md`, `README.md`, `docs/proposals/gateway-design.md` §30 | Rutas de escritura al layout flat `sessions/{session}/{interaction}/` en `src/` | pendiente |
