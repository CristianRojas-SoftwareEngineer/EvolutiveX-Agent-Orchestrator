...
description: >
  ...
  Use when the user invokes /openspec-ff or wants proposal, specs, design, and tasks generated quickly without stepping.
  Also trigger for fast forward openspec, todos los artefactos, acelerar planificacion.
license: MIT
