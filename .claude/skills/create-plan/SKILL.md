...
when_to_use: >
  ...
  tareas). For exploration, analysis, or research that mutates nothing, use investigation
  instead.
...
Only deliver the plan when all eleven checks have passed.
<!-- </verification> -->
