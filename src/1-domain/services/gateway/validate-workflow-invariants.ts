 ...
 */
export function isValidSubWorkflow(workflow: Pick<IWorkflow, 'kind' | 'parentWorkflowId' | 'parentToolUseId'>): boolean {
 ...
 */
export function assertValidSubWorkflow(workflow: Pick<IWorkflow, 'kind' | 'parentWorkflowId' | 'parentToolUseId'>): void {
