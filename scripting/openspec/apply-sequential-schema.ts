...
const CANONICAL_FILES = [
  ...
  },
  {
    ...
    source: join(SOURCE_REPO_ROOT, 'openspec', 'schemas', TARGET_SCHEMA, 'templates', 'tasks.md'),
    dest: (cwd: string) => join(cwd, 'openspec', 'schemas', TARGET_SCHEMA, 'templates', 'tasks.md'),
  },
] as const;
...
function printHelp(): void {
  console.log(`
Uso: tsx scripting/openspec/apply-sequential-schema.ts [opciones]
