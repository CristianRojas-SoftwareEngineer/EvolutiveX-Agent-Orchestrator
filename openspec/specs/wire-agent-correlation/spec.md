...
- **AND** el workflow del subagente tiene `id: 'agent-child'` (mapeo por convención de `openSubagentWorkflow`)
...
- **AND** SHALL usar el `agentId` de la entrada para invocar `getWorkflow`
