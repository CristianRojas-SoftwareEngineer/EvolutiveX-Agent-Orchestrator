...
description: >
  ...
  Use when the user invokes /openspec-verify or wants to validate coherence between code and planning artifacts.
  Also trigger for verificar implementacion openspec, comprobar cambio, validar antes de archivar.
license: MIT
