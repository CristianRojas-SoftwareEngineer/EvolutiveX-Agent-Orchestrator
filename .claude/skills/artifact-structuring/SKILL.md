...
**Generated plans** (e.g. `/create-plan`): invariant reasoning text in the command artifact is English; the plan delivered to the user is Spanish, including translated fundamental considerations.
