...
description: >
  ...
  Use when the user invokes /openspec-new or wants a new change folder before creating artifacts step by step.
  Also trigger for nuevo cambio openspec, scaffold change, crear change vacio.
license: MIT
