...
El documento de spike (`design.md` del change archivado `archive/2026-06-01--c00012-gateway-migration/phases/2026-05-30--c00010-gateway-p0-layout-diff-spike`) SHALL incluir las 5 secciones que corresponden a los criterios de aceptación de P0 definidos en el bloque P0 del orquestador `gateway-migration` (`tasks.md`).
