...
**Dependencia:** G3 archivada (`gateway-g3-step-assembler`). Decisión orquestador: integración de métricas de tokens G3/G4 en [`openspec/changes/archive/2026-06-01--c00012-gateway-migration/design.md`](../../design.md).
