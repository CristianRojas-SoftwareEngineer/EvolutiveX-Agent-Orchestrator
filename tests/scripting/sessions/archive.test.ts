...
import { setClaudeDirForTests, projectPathToSlug } from '../../../scripting/shared/claude-paths.js';
import {
  archiveSession,
  deleteSession,
  restoreSession,
  SessionManagerError,
} from '../../../scripting/sessions/archive.js';
import { readJsonFile } from '../../../scripting/sessions/shared/json-io.js';
