...
- **Spike de análisis documentado** en `openspec/changes/gateway-p0-layout-diff-spike/design.md` que cubre 5 entregables:
...
- **Affected directories:** `openspec/changes/gateway-p0-layout-diff-spike/` (nuevo), `docs/proposals/gateway-design.md` (§28b, §40, §42 actualizados).
